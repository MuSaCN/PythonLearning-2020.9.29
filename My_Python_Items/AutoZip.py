...
# ---忽略.git文件夹，备份到桌面
myfile.ZipDir(ProjectsPath, zipPath="Desktop", zipName=None, autoName=True, ignoreFolder=".git")
# ---忽略.git文件夹，备份到OneDrive的Work-Python备份文件夹
ZipPath = __mypath__.GetOneDrivePath() + "\\Work-Python备份"
myfile.ZipDir(ProjectsPath, zipPath=ZipPath , zipName=None, autoName=True, ignoreFolder=".git")
