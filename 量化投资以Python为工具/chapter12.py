...
Class_Figure5.PlotBox(0,[norm1,norm2,norm3,norm4],["std=1","std=2","std=3","std=4"],PlotLabel=["Normal Distributions with Different Standard Deviation","Standard Deviation",""])
# ---
...
Class_Figure6.PlotScatter(0,range(100),norm1,show=False)
Class_Figure6.PlotScatter(1,range(100),norm2,show=False)
Class_Figure6.PlotScatter(2,range(100),norm3,show=False)
Class_Figure6.PlotScatter(3,range(100),norm4,show=True)
